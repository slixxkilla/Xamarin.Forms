...
namespace Xamarin.Forms.Platform.iOS
{
	public class SnapHelpers
	{
		...
		public static CGPoint FindAlignmentTarget(SnapPointsAlignment snapPointsAlignment, CGPoint proposedContentOffset, 
		...
		static UICollectionViewLayoutAttributes Nearer(UICollectionViewLayoutAttributes a, UICollectionViewLayoutAttributes b,
			CGPoint target)
		{
			...
			CGRect viewport, CGPoint alignmentTarget)
		{
			...
			{
				if (!IsAtLeastHalfVisible(items[n], viewport))
				{
					continue;
				}

				bestCandidate = bestCandidate == null ? items[n] : Nearer(bestCandidate, items[n], alignmentTarget);
			}
